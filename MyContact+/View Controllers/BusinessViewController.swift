...
import UIKit
import Photos
class BusinessViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    var model : Model?
    var cardEditing : Bool?
    var redirected : Bool = false
    var contact : BusinessCard = BusinessCard()
